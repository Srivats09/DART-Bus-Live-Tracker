                ...
                row.onclick = ()=> { 
                    if(item.lat && item.lon) {
                        ...
                        if (markerToHighlight) {
                            markerToHighlight.setStyle({radius: 8, color: '#c2410c', weight: 2, fillColor: '#fdba74', fillOpacity: 1});
                            markerToHighlight.bringToFront();
                            highlightedStopMarker = markerToHighlight;
                        }
                    }
                };
